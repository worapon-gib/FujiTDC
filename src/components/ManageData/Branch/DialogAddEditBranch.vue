        ...
        this.axios
          ...
          .then((res) => {
            ...
            if (res.data.massage == "insert success") {
              ...
              this.$emit("getDataBranch");
            } else if (res.data.massage == "name already") {
              this.$emit(
                "openDialogError",
                "Unsuccessful !!",
                "Because branch name is duplicate in the system"
              );
            } else {
              this.$emit(
                "openDialogError",
        ...
        this.axios
          ...
          .then((res) => {
            ...
            if (res.data.massage == "update success") {
              ...
              this.$emit("getDataBranch");
            } else if (res.data.massage == "branch_name already") {
              this.$emit(
                "openDialogError",
                "Unsuccessful !!",
                "Because branch name is duplicate in the system"
